...
class Customer(Person):
    ...
    def enter_zoo(self, zoo):
        if self.has_ticket:
            ...
            print(f"You must first purchase a ticket to enter {zoo}")
...
class Chimp(Animal):
    ...
    def make_noise(self):
        print(" oooo oooo oooo ahhh")

    def eat_food(self):
        print("Mmm...love my bananas")
